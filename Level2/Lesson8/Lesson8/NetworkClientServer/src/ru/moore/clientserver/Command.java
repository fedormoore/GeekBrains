...
public class Command implements Serializable {
    ...
    public static Command timeLeft(Integer runTime) {
        Command command = new Command();
        command.type = CommandType.TIME_LEFT;
        command.data = new TimeLeftCommandData(runTime);
        return command;
    }
